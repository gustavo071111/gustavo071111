# 👋 Olá, eu sou Gustavo Xavier

Sou estudante de Ciência da Computação movido pela curiosidade e pela busca constante por conhecimento. Acredito que a tecnologia é uma ferramenta poderosa para resolver problemas reais, e por isso dedico meu tempo a transformar lógica de programação em soluções funcionais.
---
- 🎓 5º semestre de Ciência da Computação na Universidade Católica.
- 🧠 Em busca constante de novos conhecimentos e desafios técnicos.
- 📖 Aprofundando estudos em Arquitetura de Sistemas e Engenharia de Software.
---![C](https://github.com/user-attachments/assets/a34c1b75-2350-415d-9ee0-8cac5fa277e4)

### 🚀 Ling<svg width="256" height="256" viewBox="0 0 256 256" fill="none" xmlns="http://www.w3.org/2000/svg">
...
uagens e Tecnologias
<p align="left">
  <img src="https://skillicons.dev/icons?i=java,nodejs,ts,js,mysql,sqlite,git,github,vscode,figma" />
</p>
